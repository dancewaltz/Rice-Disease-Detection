...
DISEASE_WIKI = {
    ...
    "复合缺素(氮锰钾镁锌)": {"desc": "多种大中微量元素同时匮乏，生长严重受阻。", "advice": "追施高品质三元复合肥；喷施多元微量元素叶面肥进行综合补偿。", "url": "https://baike.baidu.com/item/科学施肥"},
    "窄褐斑病伴随复合缺素": {"desc": "病斑呈窄条状且颜色深，同时伴有氮、钾、钙等养分失衡。", "advice": "改善土壤通透性；喷施针对性杀菌剂并补充中微量元素叶面肥。", "url": "https://baike.baidu.com/item/水稻窄褐斑病"},
    "白叶枯病伴随缺硅": {"desc": "典型细菌性病害且因缺硅导致表皮坚硬度不足，病原菌极易侵入。", "advice": "喷施农用链霉素；基施或喷施硅酸钠、硅化肥增强表皮硬度。", "url": "https://baike.baidu.com/item/水稻白叶枯病"},
    "铁甲虫害与综合治理": {"desc": "叶片可见由害虫啃食形成的白色条斑。需结合管理与药剂防治。", "advice": "清理田边杂草；受害严重时喷施杀螟丹或高效氰戊菊酯。", "url": "https://baike.baidu.com/item/水稻铁甲虫"},
    "叶尖枯病伴随复合缺素": {"desc": "叶尖出现枯死斑并向下蔓延，伴随多种中微量元素匮乏。", "advice": "喷施三环唑防治病害；全面追施均衡肥料补充氮钾钙硫。", "url": "https://baike.baidu.com/item/水稻叶枯病"},
    "健康植株": {"desc": "叶片挺拔翠绿，无受害痕迹。体现了良好的肥水管理状态。", "advice": "继续保持当前科学管理方案，加强日常巡视预防。", "url": "https://baike.baidu.com/item/水稻/133543"},
    "水稻铁甲虫": {"desc": "叶片可见白色长条状食痕，系成虫啃食叶肉所致。严重时叶片枯焦。", "advice": "受害达标时喷施高效氰戊菊酯；注意清理田间杂草减少虫源。", "url": "https://baike.baidu.com/item/水稻铁甲虫"},
    "稻瘟病伴随复合缺素": {"desc": "出现梭形病斑，且因硅、氮、钾、钙不足导致植株防御力极低。", "advice": "喷施稻瘟灵或三环唑；重点补充硅肥与钾肥增强细胞壁厚度。", "url": "https://baike.baidu.com/item/稻瘟病"},
    "稻瘟病": {"desc": "典型的“梭形斑”，中心灰白边缘红褐。被称为水稻“癌症”。", "advice": "避免偏施氮肥；发病期及时喷施三环唑、稻瘟灵或吡唑醚菌酯。", "url": "https://baike.baidu.com/item/稻瘟病"}
}
...
def export_to_excel(history):
    ...
    df.to_excel(writer, index=False, sheet_name='检测记录汇总')
...
def show_report(found_classes):
    ...
    for eng_label in set(found_classes):
        ...
        with st.container(border=True):
            ...
            if info['url'] != "#":
                st.link_button(f"🔗 查看 {cn_key} 详细百科", info['url'])
